...
/*Elder: removed
	...
	s_options.multim.generic.y		= 3;
	s_options.multim.string			= "MULTIPLAYER";
	s_options.multim.color			= color_red;
	s_options.multim.style			= UI_CENTER | UI_DROPSHADOW;

	s_options.setupm.generic.type	= MTYPE_PTEXT;
	s_options.setupm.generic.flags 	= QMF_CENTER_JUSTIFY|QMF_INACTIVE|QMF_HIGHLIGHT;
	s_options.setupm.generic.x		= 280;
	s_options.setupm.generic.y		= 3;
	s_options.setupm.string			= "SETUP";
	s_options.setupm.color			= color_red;
	s_options.setupm.style			= UI_CENTER | UI_DROPSHADOW;

	s_options.demom.generic.type	= MTYPE_PTEXT;
	s_options.demom.generic.flags	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_options.demom.generic.x		= 390;
	s_options.demom.generic.y		= 3;
	s_options.demom.string			= "DEMOS";
	s_options.demom.color			= color_red;
	s_options.demom.style			= UI_CENTER | UI_DROPSHADOW;

	s_options.modsm.generic.type	= MTYPE_PTEXT;
	s_options.modsm.generic.flags 	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_options.modsm.generic.x		= 500;
	s_options.modsm.generic.y		= 3;
	s_options.modsm.string			= "MODS";
	s_options.modsm.color			= color_red;
	s_options.modsm.style			= UI_CENTER | UI_DROPSHADOW;

	s_options.exitm.generic.type	= MTYPE_PTEXT;
	s_options.exitm.generic.flags  	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_options.exitm.generic.x		= 590;
	s_options.exitm.generic.y		= 3;
