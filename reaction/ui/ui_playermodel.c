...
static void PlayerModel_MenuInit( void )
{
	...
	s_playermodel.menu.showlogo   = qtrue;
...
/*
	...
	s_playermodel.multim.generic.y	= 3;
	s_playermodel.multim.string		= "MULTIPLAYER";
	s_playermodel.multim.color		= color_red;
	s_playermodel.multim.style		= UI_CENTER | UI_DROPSHADOW;

	s_playermodel.setupm.generic.type	= MTYPE_PTEXT;
	s_playermodel.setupm.generic.flags 	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_playermodel.setupm.generic.x	= 280;
	s_playermodel.setupm.generic.y	= 3;
	s_playermodel.setupm.string		= "SETUP";
	s_playermodel.setupm.color		= color_red;
	s_playermodel.setupm.style		= UI_CENTER | UI_DROPSHADOW;

	s_playermodel.demom.generic.type	= MTYPE_PTEXT;
	s_playermodel.demom.generic.flags	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_playermodel.demom.generic.x	= 390;
	s_playermodel.demom.generic.y	= 3;
	s_playermodel.demom.string		= "DEMOS";
	s_playermodel.demom.color		= color_red;
	s_playermodel.demom.style		= UI_CENTER | UI_DROPSHADOW;

	s_playermodel.modsm.generic.type	= MTYPE_PTEXT;
//Note the following line, this makes it highlight
	s_playermodel.modsm.generic.flags 	= QMF_CENTER_JUSTIFY|QMF_INACTIVE|QMF_HIGHLIGHT;
	s_playermodel.modsm.generic.x	= 500;
	s_playermodel.modsm.generic.y	= 3;
	s_playermodel.modsm.string		= "MODS";
	s_playermodel.modsm.color		= color_red;
	s_playermodel.modsm.style		= UI_CENTER | UI_DROPSHADOW;

	s_playermodel.exitm.generic.type	= MTYPE_PTEXT;
	s_playermodel.exitm.generic.flags  	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_playermodel.exitm.generic.x	= 590;
	s_playermodel.exitm.generic.y	= 3;
