...
//	static char leaguebuffer[MAX_LEAGUELENGTH]; // TTimo: unused
	...
	g_arenaservers.menu.showlogo   = qtrue;//Blaze: Show background logo
...
*/
	...
	g_arenaservers.multim.generic.y		= 3;
	g_arenaservers.multim.string		= "MULTIPLAYER";
	g_arenaservers.multim.color			= color_red;
	g_arenaservers.multim.style			= UI_CENTER | UI_DROPSHADOW;

	g_arenaservers.setupm.generic.type	= MTYPE_PTEXT;
	g_arenaservers.setupm.generic.flags = QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	g_arenaservers.setupm.generic.x		= 280;
	g_arenaservers.setupm.generic.y		= 3;
	g_arenaservers.setupm.string		= "SETUP";
	g_arenaservers.setupm.color			= color_red;
	g_arenaservers.setupm.style			= UI_CENTER | UI_DROPSHADOW;

	g_arenaservers.demom.generic.type	= MTYPE_PTEXT;
	g_arenaservers.demom.generic.flags	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	g_arenaservers.demom.generic.x		= 390;
	g_arenaservers.demom.generic.y		= 3;
	g_arenaservers.demom.string			= "DEMOS";
	g_arenaservers.demom.color			= color_red;
	g_arenaservers.demom.style			= UI_CENTER | UI_DROPSHADOW;

	g_arenaservers.modsm.generic.type	= MTYPE_PTEXT;
	g_arenaservers.modsm.generic.flags 	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	g_arenaservers.modsm.generic.x		= 500;
	g_arenaservers.modsm.generic.y		= 3;
	g_arenaservers.modsm.string			= "MODS";
	g_arenaservers.modsm.color			= color_red;
	g_arenaservers.modsm.style			= UI_CENTER | UI_DROPSHADOW;

	g_arenaservers.exitm.generic.type	= MTYPE_PTEXT;
	g_arenaservers.exitm.generic.flags  = QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	g_arenaservers.exitm.generic.x		= 590;
	g_arenaservers.exitm.generic.y		= 3;
