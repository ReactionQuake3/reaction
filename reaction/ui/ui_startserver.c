...
*/
	...
	s_startserver.multim.generic.y		= 3;
	s_startserver.multim.string			= "MULTIPLAYER";
	s_startserver.multim.color			= color_red;
	s_startserver.multim.style			= UI_CENTER | UI_DROPSHADOW;

	s_startserver.setupm.generic.type	= MTYPE_PTEXT;
	s_startserver.setupm.generic.flags 	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_startserver.setupm.generic.x		= 280;
	s_startserver.setupm.generic.y		= 3;
	s_startserver.setupm.string			= "SETUP";
	s_startserver.setupm.color			= color_red;
	s_startserver.setupm.style			= UI_CENTER | UI_DROPSHADOW;

	s_startserver.demom.generic.type	= MTYPE_PTEXT;
	s_startserver.demom.generic.flags	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_startserver.demom.generic.x		= 390;
	s_startserver.demom.generic.y		= 3;
	s_startserver.demom.string			= "DEMOS";
	s_startserver.demom.color			= color_red;
	s_startserver.demom.style			= UI_CENTER | UI_DROPSHADOW;

	s_startserver.modsm.generic.type	= MTYPE_PTEXT;
	s_startserver.modsm.generic.flags 	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_startserver.modsm.generic.x		= 500;
	s_startserver.modsm.generic.y		= 3;
	s_startserver.modsm.string			= "MODS";
	s_startserver.modsm.color			= color_red;
	s_startserver.modsm.style			= UI_CENTER | UI_DROPSHADOW;

	s_startserver.exitm.generic.type	= MTYPE_PTEXT;
	s_startserver.exitm.generic.flags  	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	s_startserver.exitm.generic.x		= 590;
	s_startserver.exitm.generic.y		= 3;
